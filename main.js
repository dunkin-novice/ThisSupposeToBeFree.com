...
// CRITICAL FIX: Only run the converter logic if the main upload area exists on the page.
// This prevents errors on other pages like the homepage or about page.
if (uploadArea) {
